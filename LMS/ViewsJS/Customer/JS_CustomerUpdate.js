...
function loadAllTables() {
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Employment" }, function (data) {       
        ...
        append = "";
        var isSpouseExist = 0;
        $.each(data.custEmployment, function (rowkey, rowvalue) {
            if (rowvalue.IsSpouse == "Y") {
                isSpouseExist = 1;
                append = "<tr>";
                append += "<td id='" + rowvalue.ID + "' class='text-center' width='70px'><a class='btn btn-success btn-xs' title='Edit' onClick='editData(this.closest(\"tr\"),\"spouse\")'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>" +
                ...
                append += "<td id='" + rowvalue.BusinessTypeID + "'>" + rowvalue.BusinessType + "</td>";
                append += "<td>" + rowvalue.EmployerName + "</td>";
                append += "<td id='" + rowvalue.NatureOfBusinessID + "'>" + rowvalue.NatureOfBusiness + "</td>";
                append += "<td>" + rowvalue.Income + "</td>";
                append += "<td>" + rowvalue.Contact_No + "</td>";
                append += "<td>" + rowvalue.FromDate;
                if (rowvalue.ToDate == null || rowvalue.ToDate == "")
                    append += " to Present</td>";
                else
                    append += " to " + rowvalue.ToDate + "</td>";
                append += "</tr>";
                tbl.append(append);
            }
        });
        if (isSpouseExist == 0) {
            tbl.append("<tr id='delete'><td colspan='7'>The spouse neither have any employment record nor have any businesses.</td></tr>");
        }
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Address" }, function (data) {
        ...
        $.each(data.custAddress, function (rowkey, rowvalue) {
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Dependent" }, function (data) {
        ...
        $.each(data.custDependents, function (rowkey, rowvalue) {
            isDependentExist = 1;
            append = "<tr>";
            append += "<td id='" + rowvalue.ID + "' class='text-center' width='70px'><a class='btn btn-success btn-xs' title='Edit' onClick='editData(this.closest(\"tr\"),\"dependents\")'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>" +
            ...
            append += "<td id='" + rowvalue.LastName + "|" + rowvalue.FirstName + "|" + rowvalue.MiddleName + "'>" + rowvalue.LastName + ", " + rowvalue.FirstName + " " + rowvalue.MiddleName + "</td>";
            append += "<td id='" + rowvalue.GenderID + "'>" + rowvalue.Gender + "</td>";
            append += "<td>" + rowvalue.BirthDate + "</td>";
            append += "<td id='" + rowvalue.RelationshipTypeID + "'>" + rowvalue.RelationshipType + "</td>";
            append += "<td id='" + rowvalue.StreetAddress + "|" + rowvalue.CityID + "|" + rowvalue.ProvinceID + "'>" + rowvalue.StreetAddress + ", " + rowvalue.City + ", " + rowvalue.Province + "</td>";
            append += "<td>" + rowvalue.SchoolAddress + "</td>";
            append += "<td>" + rowvalue.ContactNo + "</td>";
            append += "</tr id='delete'>";
            tbl.append(append);
        });
        if (isDependentExist == 0) {
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Employment" }, function (data) {
        ...
        var isSpouseExist = 0;
        $.each(data.custEmployment, function (rowkey, rowvalue) {
            if (rowvalue.IsSpouse == "N") {
                isSpouseExist = 1;
                append = "<tr>";
                append += "<td id='" + rowvalue.ID + "' class='text-center' width='70px'><a class='btn btn-success btn-xs' title='Edit' onClick='editData(this.closest(\"tr\"),\"employment\")'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>" +
        ...
        if (isSpouseExist == 0) {
            tbl.append("<tr id='delete'><td colspan='7'>The customer have no Employment/Business Record and History.</td></tr>");
        }
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Education" }, function (data) {
        ...
        $.each(data.custEducation, function (rowkey, rowvalue) {
            isEducationExist = 1;
            append = "<tr>";
            append += "<td id='" + rowvalue.ID + "' class='text-center' width='70px'><a class='btn btn-success btn-xs' title='Edit' onClick='editData(this.closest(\"tr\"),\"education\")'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>" +
            ...
            append += "<td id='" + rowvalue.EducationTypeID + "'>" + rowvalue.EducationType + "</td>";
            append += "<td>" + rowvalue.SchoolName + "</td>";            
            append += "<td>" + rowvalue.GraduationDate + "</td>";
            append += "</tr>";
            tbl.append(append);
        });
        if (isEducationExist == 0) {
            tbl.append("<tr id='delete'><td colspan='4'>This customer do not have any acquired education.</td></tr>");
        }
    ...
    $.post("Customer/GetCustomerFullData", { Code: $("#CustRecord_Code").val(), Type: "Character" }, function (data) {
        ...
        $.each(data.custCharacter, function (rowkey, rowvalue) {
            isCharacterExist = 1;
            append = "<tr>";
            append += "<td id='" + rowvalue.ID + "' class='text-center' width='70px'><a class='btn btn-success btn-xs' title='Edit' onClick='editData(this.closest(\"tr\"),\"character\")'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a>" +
            ...
            append += "<td id='" + rowvalue.LastName + "|" + rowvalue.FirstName + "|" + rowvalue.MiddleName + "'>" + rowvalue.LastName + ", " + rowvalue.FirstName + " " + rowvalue.MiddleName + "</td>";
            append += "<td>" + rowvalue.RelationShip + "</td>";
            append += "<td id='" + rowvalue.StreetAddress + "|" + rowvalue.CityID + "|" + rowvalue.ProvinceID + "'>" + rowvalue.StreetAddress + ", " + rowvalue.City + ", " + rowvalue.Province + "</td>";
            append += "<td>" + rowvalue.ContactNo + "</td>";
            append += "</tr>";
            tbl.append(append);
        });
        if (isCharacterExist == 0) {
            tbl.append("<tr id='delete'><td colspan='5'>This customer have no character reference available.</td></tr>");
        }
